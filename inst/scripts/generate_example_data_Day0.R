...
write.table(df_merged_data_day0, "../testdata/synthdata_small_wDay0_no_noise_rawdata.tsv", quote = FALSE, row.names = FALSE, sep = "\t")
...
finalSE_1_Ligand_day0 <- gDRcore::runDrugResponseProcessingPipeline(df_merged_data_day0, override_untrt_controls = c(Ligand = 0.1))
...
write.table(df_merged_data, "../testdata/synthdata_wLigand_wDay0_rawdata.tsv", quote = FALSE, row.names = FALSE, sep = "\t")
