...
finalSE_1_no_noise <- process_data_to_SLigand(df_merged_data)


df_merged_data_day0 <- add_day0_data(df_merged_data, 0)
finalSE_1_no_noise_day0 <- process_data_to_SLigand(df_merged_data_day0)
...
finalSE_1_Ligand <- process_data_to_SLigand(df_merged_data, override_untrt_controls = c(Ligand = 0.1))
finalSE_1_Ligand_day0 <- process_data_to_SLigand(df_merged_data_day0, override_untrt_controls = c(Ligand = 0.1))
