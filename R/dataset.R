...
#'   \item{DepmapModelType}{Abbreviated ID for model type. For cancer models, from Oncotree; for other disease types, generated by DepMap}
#'   \item{OncotreeLineage}{Primary cancer lineage classification (from Oncotree for cancer models, generated by DepMap for others)}
#'   \item{OncotreePrimaryDisease}{Primary disease of model (from Oncotree for cancer models, generated by DepMap for others)}
#'   \item{OncotreeSubtype}{Subtype classification of model (from Oncotree for cancer models, generated by DepMap for others)}
#'   \item{OncotreeCode}{Oncotree code for cancer models; left blank if no corresponding code exists}
